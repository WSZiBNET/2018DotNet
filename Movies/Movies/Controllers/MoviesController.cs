...
namespace Movies.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MovieId,Title,ProductionDate,Price,MovieDescription,GenreId,AuthorId")] Movie movie)
        {
            ...
            ViewData["GenreName"] = movie.Genres.Name;
            return View(movie);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MovieId,Title,ProductionDate,Price,MovieDescription,GenreId,AuthorId")] Movie movie)
        {
            if (id != movie.MovieId)
            {
                return NotFound();
